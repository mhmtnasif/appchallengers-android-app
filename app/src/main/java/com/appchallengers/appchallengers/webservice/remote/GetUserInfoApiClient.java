...
public class GetUserInfoApiClient {
    ...
    public static GetUserInfo getUserInfoClientWithCache(Context context) {
        mContext = context;
        return getRetroClientWithCache().create(GetUserInfo.class);
    }
