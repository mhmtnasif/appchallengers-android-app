...
public class GetProfileApiClient {
    ...
    public static GetProfileInfo getProfileClientWithCache(Context context) {
        mContext = context;
        return getRetroClientWithCache().create(GetProfileInfo.class);
    }
